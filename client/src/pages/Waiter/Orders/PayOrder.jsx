...
import { dropIn, dropInToLeft, getTotalOrderValue } from '../../../functions'
...
export const PayOrder = ({ setOpenPayOrder, currentOrder }) => {
    ...
    return (
        <Modal onClick={() => setOpenPayOrder(false)}>
            <motion.div onClick={(e) => e.stopPropagation()} variants={dropInToLeft} initial='hidden' animate='visible' exit='exit' className='absolute w-full flex justify-center'>
