                ...
                <Suspense fallback={<Loader />}>
                    ...
                    ">
                        {restaurants.length > 0 ? restaurants.map((restaurant, i) =>
                            <li key={restaurant._id} className="flex items-center p-10 rounded-lg cursor-pointer shadow-lg hover:bg-sky-900/5 transition ease-out hover:ease-in w-[250px] h-[150px]
