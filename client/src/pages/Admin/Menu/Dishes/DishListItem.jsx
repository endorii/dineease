    ...
    return (
        <>
            ...
            {categoryFilter === 'all' || item.categoryName === categoryFilter ? <tr className="bg-white border-b border-gray-300 text-gray-700" >
                <th scope="row" className="py-4 pl-4 font-medium text-gray-900">
                    {item.name}
                </th>
                ...
                <td className="p-1">
                    <div className="flex justify-end">
                        <img src={Info} onClick={() => { setOpenInfo(true) }}
                            className="h-10 cursor-pointer hover:shadow-2xl hover:bg-sky-950/10 p-1 rounded-2xl transition ease-out hover:ease-in" alt="" />
                    </div>
                </td>
                <td className="p-1 text-center">
