...
const AddEmployee = ({ setOpen }) => {
    ...
    const handleName = (e) => {
        ...
        if (!re.setClassesForInputs(String(e.target.value).toLowerCase())) {
    ...
    const handlePhoneNumber = (e) => {
        ...
        const re = /^\+380\d{9}$/;
        if (!re.setClassesForInputs(String(e.target.value))) {
    ...
    return (
        <Modal onClick={() => setOpen(false)}>
            <motion.div
                ...
                animate="visible"
                exit="exit"
                className="absolute w-[95%] h-max flex justify-center m-5 cursor-default
            lg:w-[70%]"
            >
                <div className="relative bg-white shadow-xl w-full z-10 rounded-md">
                    <div className="flex flex-col items-center mx-3 gap-3">
                        <img
                            ...
                            alt=""
                        />
                        <span className="text-center text-3xl mt-6 text-sky-900 font-semibold">
                            Ведіть дані нового працівника
                        </span>
                        <ul className="flex justify-center w-[90%] m-10 gap-10 text-sky-900">
                            ...
                            <div className="flex flex-col gap-5 w-full">
                                ...
                                <li>
                                    ...
                                    <select
                                        ...
                                        className={setClassesForInputs(null)}
                                        required
                                    >
                        ...
                        <button
                            disabled={nameError || ageError || experienceError}
