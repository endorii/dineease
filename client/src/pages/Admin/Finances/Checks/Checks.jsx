    ...
    return (
        <>
            <AnimatePresence initial={orderDeleteOpen}>
                {orderDeleteOpen && (
                    <ConfirmModal
                        setModalOpen={setOrderDeleteOpen}
                        onConfirm={async () => {
            ...
            <div className="flex flex-col h-full">
                ...
                <div
                    className="flex gap-2 items-center flex-wrap pb-5 justify-between
                               lg:gap-3
                "
                >
                    <div className="flex gap-2">
                        ...
                        {ordersStates.length > 0
                            ? ordersStates.map((state, i) => (
                                  <div
                                      className={`px-4 py-2 text-white rounded-2xl hover:bg-sky-900 transition ease-out hover:ease-in cursor-pointer ${
                                          orderState === state
                                              ? "bg-sky-950"
                                              : "bg-sky-700"
                                      }`}
                                ...
                                order._id
                                    ...
                                    <tbody key={i}>
                                        <tr className="bg-white border-b border-gray-300 text-gray-700">
                                            <th
                                                scope="row"
                                                className="px-5 font-medium text-gray-900 w-[20%] text-sm lg:px-10 "
                                            >
                                                {order._id.slice(0, 10)}...
                                            </th>
                                            <td
                                                className="w-[15%] text-center text-sm font-bold
                                                           md:text-base
                                                           lg:p-1"
                                            >
                                            ...
                                            <td className="w-[15%]">
                                                <div className="flex justify-center items-center">
                                                    ...
                                                    >
                                                        <img
                                                            className="h-10 cursor-pointer hover:shadow-2xl hover:bg-sky-950/10 p-1 rounded-2xl transition ease-out hover:ease-in"
                                                            src={Info}
                                                            alt=""
                                                        />
                                                    </div>
                                                    ...
                                                    >
                                                        <img
                                                            className="h-11 cursor-pointer hover:shadow-2xl hover:bg-sky-950/10 p-1 rounded-2xl transition ease-out hover:ease-in"
                                                            src={TrashDone}
                                                            alt=""
                                                        />
                                                    </div>
