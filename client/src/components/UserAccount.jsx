            ...
            <div className='flex justify-center items-center'>
                ...
                <div className='flex flex-col gap-10 bg-white w-[80%] p-20 shadow-inner border'>
                    ...
                    <div className='flex flex-raw items-center gap-[10%]'>
                        ...
                        <input type="text" value={user.workingTime} className="pl-5 block w-96 h-10 rounded-md border py-1.5 text-gray-900 shadow-sm text-lg" />
                    </div>
                    <div className='flex flex-raw items-center gap-[10%]'>
                        <div className='mr-2 w-72 text-xl text-sky-800 font-medium bg-teal-600/20 py-3 px-5 rounded-md'>Ім'я акаунту: </div>
                        <input type="text" value={user.name} className="pl-5 block w-96 h-10 rounded-md border py-1.5 text-gray-900 shadow-sm text-lg" />
                    </div>


                    <div className='flex flex-raw items-center gap-[10%]'>
                        <div className='mr-2 w-72 text-xl text-sky-800 font-medium bg-teal-600/20 py-3 px-5 rounded-md'>Ресторан: </div>
                        <input type="text" value={user.restaurant} className="pl-5 block w-96 h-10 rounded-md border py-1.5 text-gray-900 shadow-sm text-lg" />
                    </div>


                    <div className='flex flex-raw items-center gap-[10%]'>
                        <div className='mr-2 w-72 text-xl text-sky-800 font-medium bg-teal-600/20 py-3 px-5 rounded-md'>Email: </div>
                        <input type="text" value={user.email} className="pl-5 block w-96 h-10 rounded-md border py-1.5 text-gray-900 shadow-sm text-lg" />
                    </div>

                    <div className='flex flex-raw items-center gap-[10%]'>
                        <div className='mr-2 w-72 text-xl text-sky-800 font-medium bg-teal-600/20 py-3 px-5 rounded-md'>Зарплата </div>
                        <input type="text" value={user.salary} className="pl-5 block w-96 h-10 rounded-md border py-1.5 text-gray-900 shadow-sm text-lg" />
                    </div>
